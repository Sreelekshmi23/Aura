    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-slate-800 flex flex-col relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                ...
                <div className="absolute top-[20%] left-[20%] w-[250px] h-[250px] md:w-[400px] md:h-[400px] bg-purple-100/50 rounded-full blur-3xl opacity-40 mix-blend-multiply animate-blob animation-delay-4000"></div>
            </div>
            ...
            <main className="flex-grow flex items-center justify-center p-6 relative z-10">
                <div className="max-w-5xl w-full">
                    ...
                    <div className="text-center space-y-8 mb-16 animate-in slide-in-from-bottom-10 fade-in duration-1000">
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-[#0F40C5] to-slate-900 tracking-tighter pb-4 drop-shadow-sm animate-gradient-x leading-tight">
                            TRUE SUN TRADING COMPANY
                        </h1>
                        <p className="text-lg sm:text-xl md:text-2xl text-slate-500 max-w-3xl mx-auto leading-relaxed font-medium px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        ...
                        <div
                            ...
                            className="group relative bg-white/60 backdrop-blur-2xl p-6 sm:p-10 rounded-3xl sm:rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-white/60 hover:border-blue-200 hover:shadow-blue-500/20 transition-all duration-500 cursor-pointer overflow-hidden transform hover:-translate-y-2"
                        >
                        ...
                        <div
                            ...
                            className="group relative bg-white/60 backdrop-blur-2xl p-6 sm:p-10 rounded-3xl sm:rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-white/60 hover:border-indigo-200 hover:shadow-indigo-500/20 transition-all duration-500 cursor-pointer overflow-hidden transform hover:-translate-y-2"
                        >
